...
_EVENT_VERBS: dict[str, str] = {
    ...
    "resource_changed": "harvested resources",
    "resource_transferred": "transferred resources",
    "agent_left_region": "left the region",
    "agent_entered_region": "arrived",
    "mating_initiated": "proposed mating",
    "mating_rejected": "rejected a mating proposal",
    "mating_proposal_timeout": "let a mating offer lapse",
    "mating_proposal_invalidated": "had a mating offer fall through",
    "simulation_started": "the world wakes",
