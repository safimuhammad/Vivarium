...
> Operating manual for Codex working on this repository. Read top to bottom at the
...
The owner (**Safi**) is the **visionary/architect**; **Codex is the builder and
implementation manager**. Safi defines intent, reviews direction, and steers
decisions that change the *meaning* of the simulation. Codex does the rest:
designing components, writing code, testing, and integrating.

**How Codex operates here:**

1. **Orchestrator-first.** For any non-trivial component, Codex acts as an
...
3. **Context discipline / checkpointing.** The main context window is a scarce
   resource. Codex anchors checkpoints regularly to `.remember/remember.md`
...
- **Design decisions** that change the simulation's meaning get recorded in
  ...
  current.
- **This file (`AGENTS.md`)** holds durable standards. Update it when a standard or
