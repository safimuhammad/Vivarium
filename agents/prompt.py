...
WORLD_MECHANICS: str = (
    ...
    "- Some acts reach beyond you: speaking, travelling, gathering, giving, making an "
    "offer, striking, tending a home, breaking in, or picking over ruins can be seen, "
    "heard, or felt by the world around you. Looking around only sharpens your own "
    "awareness; it changes nothing and reaches no one else.\n"
