...
DETAIL_LABELS = {0: "owner", 1: "stakeholder-1", 2: "stakeholder-2", 3: "stakeholder-3", 4: "stakeholder-4",
...
def main() -> None:
    ...
    detail_sheet = row(cells(details, 32, 8, 32)[: len(detail_names)], detail_names, 32, len(detail_names))
    ...
    d = ImageDraw.Draw(sheet)
    y = 6
    d.text((8, y), "hut-kit (sprite-scale re-derivation) -- components.png (24 frames)", fill=(20, 20, 20, 255))
    y += section_title_h
    ...
    d.text((8, y), "details.png (10 of 32 slots authored, byte-identical carry-over)", fill=(20, 20, 20, 255))
    y += section_title_h
