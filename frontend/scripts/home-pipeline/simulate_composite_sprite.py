"""Simulate HomeActor's #visual() stacking for the sprite-scale hut kit so
real in-engine layer combinations can be eyeballed before promoting the kit.

Mirrors HomeActor.ts #visual(): back = [foundation, post, wall, window,
hearth, chimney]; front = [roof, door]. Renders representative states.
"""
...
OUT = "/Users/muhammadsafi/Desktop/software-dev/simulation/frontend/scripts/home-pipeline/work-sprite/components"
PREVIEW = "/Users/muhammadsafi/Desktop/software-dev/simulation/frontend/scripts/home-pipeline/work-sprite/preview"
CELL = 128
...
SCENARIOS = {
    ...
    "intact-door-open-warm": (
        ["foundation", "post", "wall-intact", "window-lit", "hearth-lit-1", "chimney"],
        ["roof-intact", "door-open"],
    ),
    "cracked-mid-integrity": (
        ["foundation", "post", "wall-cracked", "window-cold", "hearth-cold", "chimney"],
        ["roof-damaged", "door-closed"],
    ),
    "broken-low-integrity": (
